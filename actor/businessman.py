...
class Businessman(pygame.sprite.Sprite):
    def __init__(self,pos_x,pos_y):
        ...
        self.action = Action('img/elder/elder4-0000', 10, True)
        self.pos_x = pos_x
        self.pos_y = pos_y
        self.image_count = 6
        self.width = 40
        ...
        self.dialog = BusinessmanDialog(1)
        self.stop = False
